...
// ── Shared content sections (used by Landing page and About tab) ────
    ...
    <>
      ...
      <section className="relative py-16 sm:py-24">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="animate-slide-up-delay-3 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {[
      ...
      <section id="features" className="relative py-24 sm:py-32">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <FeatureCard delay={160} accent="from-[#B8FF00]/20 to-[#B8FF00]/5"
              icon={<svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 01.865-.501 48.172 48.172 0 003.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" /></svg>}
              title="Ask Cricket AI" description="Ask any question in plain English. Powered by Gemini AI with context-aware SQL generation and instant chart rendering." />
            <FeatureCard delay={240} accent="from-[#FFB800]/20 to-[#FFB800]/5"
              icon={<svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456z" /></svg>}
              title="Content Studio" description="Generate share-ready stat cards for Twitter, Instagram, and LinkedIn. Player stats, match summaries, and comparison templates with AI captions." />
            <FeatureCard delay={320} accent="from-[#FF2D78]/20 to-[#FF2D78]/5"
              ...
              title="Player Impact Scores" description="Proprietary impact scoring with 15+ weighted metrics. Auto-detects player roles and ranks across batting, bowling, and all-round ability." />
            <FeatureCard delay={400} accent="from-[#8B5CF6]/20 to-[#8B5CF6]/5"
              ...
              title="Head-to-Head Analysis" description="Compare any two teams or players across all dimensions with super over resolution and historical matchup records." />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ShowcaseCard delay={300} title="Content Studio" description="Generate share-ready stat cards in branded templates for social media." gradient="from-[#FFB800] to-[#FFB800]/50" mockup={(vis) => <MockContentStudio animate={vis} />}
              features={['Player stats, match summary, comparison templates', 'Twitter, Instagram, LinkedIn, Portrait formats', 'Download PNG or copy to clipboard', 'AI-generated captions for each platform']} />
            <ShowcaseCard delay={400} title="Orange & Purple Cap Tracker" description="Season-by-season cap winners with clickable player profiles." gradient="from-[#FFB800] to-[#8B5CF6]" mockup={(vis) => <MockCapTracker animate={vis} />}
              features={['Most runs scorer per season (Orange Cap)', 'Most wickets taker per season (Purple Cap)', 'Click any player to view full career stats', 'Chase analysis and dismissal breakdowns']} />
            <ShowcaseCard delay={500} title="Interactive Venue Map" description="India map with all IPL grounds plotted as animated, clickable markers." gradient="from-[#B8FF00] to-[#B8FF00]/50" mockup={(vis) => <MockVenueMap animate={vis} />}
              features={['Zoomable India map with venue markers', 'Click any ground to see venue profile', 'Multi-venue city auto-navigation', '30+ venue name normalizations for clean data']} />
          </div>
        </div>
      </section>
