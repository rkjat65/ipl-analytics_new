export const TEAM_COLORS = {
  ...
  'Delhi Capitals': { primary: '#4B90D9', secondary: '#EF1B23', abbr: 'DC' },
  'Delhi Daredevils': { primary: '#4B90D9', secondary: '#EF1B23', abbr: 'DD' },
  'Punjab Kings': { primary: '#ED1B24', secondary: '#A7A9AC', abbr: 'PBKS' },
  'Kings XI Punjab': { primary: '#ED1B24', secondary: '#A7A9AC', abbr: 'KXIP' },
