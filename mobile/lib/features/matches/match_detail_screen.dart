...
class _MatchDetailScreenState extends State<MatchDetailScreen> {
  ...
  String _oversFromBalls(dynamic balls) {
    final n = (balls is num) ? balls.toInt() : int.tryParse(balls?.toString() ?? '') ?? 0;
    return '${n ~/ 6}.${n % 6}';
  }
  ...
  String _dismissalText(Map<String, dynamic> b) {
    ...
    switch (kind) {
      ...
      case 'stumped':
        return fielder != null && bowler != null ? 'st $fielder b $bowler' : 'stumped';
      default:
  ...
  Widget _buildBody(Map<String, dynamic> info, String t1, String t2) {
    ...
    final innIndex = scorecards.isEmpty ? 0 : _tab.clamp(0, scorecards.length - 1);
      ...
      children: [
            ...
            children: [
              Row(
                children: [
                  ...
                  const Spacer(),
                  Text(formatDate(info['date']), style: const TextStyle(fontSize: 11, color: CrickTheme.textMuted)),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text('VS', style: GoogleFonts.spaceGrotesk(fontWeight: FontWeight.w800, color: CrickTheme.cyan, fontSize: 16)),
              ...
              if (info['venue'] != null) ...[
                ...
                Text(
                  info['venue'].toString(),
                  textAlign: TextAlign.center,
                  style: const TextStyle(fontSize: 12, color: CrickTheme.textMuted),
                ),
              ],
            ],
          ),
        ...
        Padding(
          ...
          child: Wrap(
            ...
            runSpacing: 8,
            children: [
              _metaChip(Icons.sports, 'Toss: ${info['toss_winner'] ?? '—'} (${info['toss_decision'] ?? ''})'),
              if (info['player_of_match'] != null)
                GestureDetector(
                  onTap: () => _openPlayer(info['player_of_match'].toString()),
                  child: _metaChip(Icons.emoji_events_outlined, 'PoM: ${info['player_of_match']}', color: CrickTheme.amber),
                ),
              if (info['umpire1'] != null) _metaChip(Icons.person_outline, 'Umpires: ${info['umpire1']}, ${info['umpire2'] ?? ''}'),
            ],
          ),
        ),

        if (scorecards.isEmpty)
          const CrickCard(child: Text('Scorecard data not available for this match.', style: TextStyle(color: CrickTheme.textSecondary)))
        else ...[
          // Innings switcher
          Padding(
            ...
            child: Row(
              children: List.generate(scorecards.length, (i) {
                ...
                final team = sc['batting_team']?.toString() ?? 'Innings ${i + 1}';
                return Expanded(
                  child: Padding(
                    padding: EdgeInsets.only(right: i < scorecards.length - 1 ? 8 : 0),
                    child: Material(
                      color: selected ? CrickTheme.cyan.withValues(alpha: 0.14) : CrickTheme.bgCard,
                      borderRadius: BorderRadius.circular(12),
                      child: InkWell(
                        borderRadius: BorderRadius.circular(12),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(
                              color: selected ? CrickTheme.cyan.withValues(alpha: 0.5) : CrickTheme.borderSubtle,
                            ),
                          ),
                          child: Column(
                            children: [
    ...
    return Column(
      ...
      children: [
          ...
          child: Row(
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.jetBrainsMono(color: CrickTheme.cyan, fontWeight: FontWeight.w800, fontSize: 15),
              ),
            ],
          ),
        ),
        ...
        Container(
          ...
          child: Row(
            children: [
              const Expanded(flex: 5, child: Text('Batter', style: TextStyle(fontSize: 11, color: CrickTheme.textMuted, fontWeight: FontWeight.w600))),
              _colH('R', 28),
              _colH('B', 28),
              _colH('4s', 28),
              _colH('6s', 28),
          ...
          child: Column(
            children: [
              ...batters.map((b) {
                ...
                final isOut = b['dismissal'] != null && b['dismissal'].toString().isNotEmpty;
                return InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 11,
                                        color: isOut ? CrickTheme.textMuted : CrickTheme.lime,
                                      ),
                                    ),
                                  ],
                                ),
                        ...
                        _colV(formatNumber(b['runs']), 28, bold: true, color: CrickTheme.cyan),
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  border: Border(top: BorderSide(color: CrickTheme.borderSubtle)),
                ),
                child: Row(
                  children: [
                    const Expanded(
                    ...
                    Text(
                      ...
                      style: GoogleFonts.jetBrainsMono(fontWeight: FontWeight.w700, color: CrickTheme.cyan, fontSize: 13),
                    ),
                  ],
                ),
              ),
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.jetBrainsMono(fontSize: 11, color: CrickTheme.purple, fontWeight: FontWeight.w700),
                    ),
                  ),
                  ...
                  Text(
                    ...
                    style: GoogleFonts.jetBrainsMono(fontSize: 12, color: CrickTheme.lime, fontWeight: FontWeight.w700),
                  ),
                ],
              ),
            );
        ...
        if (bowlers.isNotEmpty) ...[
          ...
          Container(
            ...
            child: Row(
              children: [
                const Expanded(flex: 5, child: Text('Bowler', style: TextStyle(fontSize: 11, color: CrickTheme.textMuted, fontWeight: FontWeight.w600))),
                _colH('O', 32),
                _colH('M', 28),
                _colH('R', 32),
                _colH('W', 28),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        _colV(formatNumber(b['runs_conceded'] ?? b['runs']), 32),
                        _colV(formatNumber(b['wickets']), 28, bold: true, color: CrickTheme.magenta),
  ...
  Widget _teamCol(String team, {bool end = false}) {
    return Column(
      ...
      children: [
        ...
        Text(
          teamAbbr(team),
          style: GoogleFonts.spaceGrotesk(fontWeight: FontWeight.w800, fontSize: 18, color: teamColor(team)),
        ),
        Text(
          team,
          ...
          style: const TextStyle(fontSize: 11, color: CrickTheme.textSecondary, height: 1.25),
        ),
      ],
    );
  }

  Widget _metaChip(IconData icon, String text, {Color color = CrickTheme.textSecondary}) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          ConstrainedBox(
            ...
            child: Text(text, style: TextStyle(fontSize: 11, color: color), maxLines: 2, overflow: TextOverflow.ellipsis),
          ),
        ],
      ),
    );
  ...
  Widget _colH(String t, double w) => SizedBox(
        width: w,
        child: Text(t, textAlign: TextAlign.right, style: const TextStyle(fontSize: 11, color: CrickTheme.textMuted, fontWeight: FontWeight.w600)),
      );

  Widget _colV(String t, double w, {bool bold = false, Color? color}) => SizedBox(
        width: w,
        child: Text(
          t,
