          ...
          : ListView(
              children: [
                    ...
                    child: GridView.count(
                      ...
                      children: [
                        StatCard(
                          label: 'Matches',
                          value: formatNumber(
                            _stats!['matches'] ?? _stats!['played'],
                          ),
                        ),
                        StatCard(
                          label: 'Wins',
                          value: formatNumber(_stats!['wins']),
                          color: CrickTheme.lime,
                        ),
                        StatCard(
                          label: 'Win %',
                          value: formatDecimal(
                            _stats!['win_pct'] ?? _stats!['win_percentage'],
                          ),
                        ...
                        StatCard(
                          label: 'Titles',
                          value: formatNumber(
                            _stats!['titles'] ?? _stats!['championships'],
                          ),
                    ...
                    child: Column(
                      children: [
                        KeyValueRow(
                          'Highest score',
                          formatNumber(
                            _stats!['highest_score'] ??
                                _stats!['highest_total'],
                          ),
                        ),
                        KeyValueRow(
                          'Lowest score',
                          formatNumber(
                            _stats!['lowest_score'] ?? _stats!['lowest_total'],
                          ),
                        ),
                        KeyValueRow(
                          'Avg scored',
                          formatDecimal(
                            _stats!['avg_scored'] ?? _stats!['avg_runs'],
                          ),
                        ),
                        KeyValueRow(
                          'Avg conceded',
                          formatDecimal(_stats!['avg_conceded']),
                        ),
                      ],
                    ),
                  ),
                ...
                if (_h2h.isNotEmpty) ...[
                  ...
                  ..._h2h.map((h) {
                    final opp = (h['opponent'] ?? h['team'] ?? h['vs'] ?? '')
                        .toString();
                    return CrickCard(
                      child: Row(
                        children: [
